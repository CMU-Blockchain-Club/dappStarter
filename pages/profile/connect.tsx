     ...
     <Navbar></Navbar>
        ...
        <div className="max-w-2xl mx-auto grid place-items-center">
        {
          ...
          <div className="textCenter">
            ...
            <p>
              Address: <span className="bg-clip-text text-green-400">{authContext.wallet.address}</span>
            </p>
            <p>
          ...
          <div>
             ...
             <div className="p-4 max-w-sm bg-white rounded-lg border shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700 hover:border-cyan-300">
              ...
              <ul className="my-4 space-y-3">
                  <li>
                      <a href="#" onClick={() => handleConnect("metamask")} className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
